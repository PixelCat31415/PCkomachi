...
\item Green Hackenbush: Run BCC(bridge), each BCC has grundy value $g_v = |E| \bmod 2$ (the grundy value remains unchanged if we identify a circuit as a node). Run DFS with root \textit{ground} and $g_v \^= (g_h + 1)$ for vertex $v$ and its child $h$.  
\end{itemize}
