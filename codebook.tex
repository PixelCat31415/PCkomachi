...
\setmainfont{UbuntuSans}[
    Path=fonts/Ubuntu_Sans/static/,
    Extension=.ttf,
    UprightFont=*-Regular,
    BoldFont=*-Bold,
    ItalicFont=*-Italic,
...
\fancyhead[L]{National Taiwan University theseus\_advantage}
\fancyhead[R]{\thepage}
\renewcommand{\headrulewidth}{0.4pt}
\renewcommand{\contentsname}{Contents}
\newcommand{\getfilehash}[1]{\captureshell{cpp #1 -dD -P -fpreprocessed | tr -d '[:space:]' | md5sum | cut -c-6}}
\newcommand{\inputcode}[2]{
    \IfFileExists{#2.auto}{
        \subsection[#1]{#1 \footnotesize{[\texttt{\getfilehash{#2.auto}}]}}
